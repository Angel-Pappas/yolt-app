...
import { updateLeadNextStep } from "./actions";

/**
 * Inline-editable Next step cell on the leads list — click to edit without
 * opening the lead. stopPropagation everywhere so a click never triggers the
...
export function EditableNextStep({
  ...
  function save() {
    startTransition(async () => {
      try {
        await updateLeadNextStep(leadId, text);
        setEditing(false);
      } catch {
