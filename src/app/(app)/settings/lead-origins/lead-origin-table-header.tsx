...
import { LEAD_ORIGIN_SORT_KEYS, type LeadOriginSortKey } from "./queries";

export function LeadOriginTableHeader() {
  const { currentSort, currentDir, handleSort } =
    useSortState<LeadOriginSortKey>(LEAD_ORIGIN_SORT_KEYS);
