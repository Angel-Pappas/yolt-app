...
import { PROJECT_STATUS_SORT_KEYS, type ProjectStatusSortKey } from "./queries";

export function ProjectStatusTableHeader() {
  const { currentSort, currentDir, handleSort } =
    useSortState<ProjectStatusSortKey>(PROJECT_STATUS_SORT_KEYS);
